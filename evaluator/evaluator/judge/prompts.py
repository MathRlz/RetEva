...
ANSWER_QUALITY_SYSTEM_PROMPT = (
    "You are evaluating answer quality for a medical QA benchmark. "
    "Compare the generated answer to the reference answer and score quality. "
    "Return strict JSON with fields: score (0..1 float), verdict (PASS|FAIL), reason (short string)."
)

ANSWER_QUALITY_USER_TEMPLATE = (
    "Question: {question}\n\n"
    "Reference answer: {reference_answer}\n\n"
    "Generated answer: {generated_answer}\n\n"
    "Score how well the generated answer conveys the same information as the reference answer "
    "(0.0 = completely wrong, 1.0 = perfect match in meaning). "
    'Return strict JSON: {{"score": <0..1>, "verdict": "PASS|FAIL", "reason": "..."}}'
)

...
Split out of the former ``evaluation/phased.py`` god module (Phase 1, audit §1). Each
submodule registers its handlers via ``@register_stage_handler`` at import time, so the
